...
<div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input value="{{ @$diarista->telefone }}" type="text" class="form-control" id="telefone" name="telefone" required maxlength="11">
            </div>

            <div class="mb-3">
                <label for="logradouro" class="form-label">Logradouro</label>
                <input value="{{ @$diarista->logradouro }}" type="text" class="form-control" id="logradouro" name="logradouro" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ @$diarista->codigo_ibge }}" type="text" class="form-control" id="codigo_ibge" name="codigo_ibge" required maxlength="20">
            </div>
